...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_feedback_submissions_tenant_status", "feedback_submissions", ["tenant_id", "status"]
    )
    op.create_index(
        "ix_feedback_submissions_tenant_submitter",
        "feedback_submissions",
        ["tenant_id", "submitter_id"],
    )
    op.create_index(
        "ix_feedback_submissions_tenant_type", "feedback_submissions", ["tenant_id", "type"]
    )
    ...
    op.create_index(
        "ix_feedback_messages_submission_created",
        "feedback_messages",
