...
<!--
  ...
  BRANCH NAMING: Replace "###-feature-name" with actual spec folder name.
  - Get from: the spec folder path (e.g., specs/003-xero-oauth/)
  - Or from: ROADMAP.md current focus section
  - Example: specs/003-xero-oauth/ → use "003-xero-oauth" everywhere
...
**Branch Naming**: The branch name MUST match the spec folder name.
- Spec folder: `specs/###-feature-name/` → Branch: `feature/###-feature-name`
- Example: `specs/003-xero-oauth/` → Branch: `feature/003-xero-oauth`
...
- [ ] TFINAL-1 Ensure all tests pass
  - Run: `pytest` or equivalent test command
  - All tests must pass before PR

- [ ] TFINAL-2 Run linting and type checking
  - Run: `ruff check` and `mypy` (or equivalent)
  - Fix any issues

- [ ] TFINAL-3 Push feature branch and create PR
  - Run: `git push -u origin feature/###-feature-name`
  - Run: `gh pr create --title "Spec ###: [Feature Name]" --body "..."`
  - Example: For `specs/003-xero-oauth/`:
    - `git push -u origin feature/003-xero-oauth`
    - `gh pr create --title "Spec 003: Xero OAuth" --body "..."`
...
- **Setup (Phase 1)**: Depends on Phase 0 - can start immediately after branch creation
